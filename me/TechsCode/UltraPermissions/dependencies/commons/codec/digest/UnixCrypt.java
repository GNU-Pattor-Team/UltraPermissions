...
/* 185 */     return crypt(paramArrayOfbyte, (String)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 206 */       ThreadLocalRandom threadLocalRandom = ThreadLocalRandom.current();
/* 207 */       int m = SALT_CHARS.length;
/*     */       
/* 209 */       paramString = "" + SALT_CHARS[threadLocalRandom.nextInt(m)] + SALT_CHARS[threadLocalRandom.nextInt(m)];
/* 210 */     } else if (!paramString.matches("^[./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz]{2,}$")) {
/* 211 */       throw new IllegalArgumentException("Invalid salt value: " + paramString);
/*     */     } 
/*     */     
/* 214 */     StringBuilder stringBuilder = new StringBuilder("             ");
/* 215 */     char c1 = paramString.charAt(0);
/* 216 */     char c2 = paramString.charAt(1);
/* 217 */     stringBuilder.setCharAt(0, c1);
/* 218 */     stringBuilder.setCharAt(1, c2);
/* 219 */     int i = CON_SALT[c1];
/* 220 */     int j = CON_SALT[c2] << 4;
/* 221 */     byte[] arrayOfByte1 = new byte[8]; byte b1;
/* 222 */     for (b1 = 0; b1 < arrayOfByte1.length; b1++) {
/* 223 */       arrayOfByte1[b1] = 0;
/*     */     }
/*     */     
/* 226 */     for (b1 = 0; b1 < arrayOfByte1.length && b1 < paramArrayOfbyte.length; b1++) {
/* 227 */       byte b = paramArrayOfbyte[b1];
/* 228 */       arrayOfByte1[b1] = (byte)(b << 1);
/*     */     } 
/*     */     
/* 231 */     int[] arrayOfInt1 = desSetKey(arrayOfByte1);
/* 232 */     int[] arrayOfInt2 = body(arrayOfInt1, i, j);
/* 233 */     byte[] arrayOfByte2 = new byte[9];
/* 234 */     intToFourBytes(arrayOfInt2[0], arrayOfByte2, 0);
/* 235 */     intToFourBytes(arrayOfInt2[1], arrayOfByte2, 4);
/* 236 */     arrayOfByte2[8] = 0;
/* 237 */     byte b2 = 2;
/* 238 */     byte b3 = 0;
/* 239 */     int k = 128;
/* 240 */     for (; b2 < 13; b2++) {
...
/* 251 */           k = 128;
/*     */         } 
/* 253 */         stringBuilder.setCharAt(b2, (char)COV2CHAR[m]);
/*     */       } 
/*     */     } 
...
/* 271 */     return crypt(paramString.getBytes(Charsets.UTF_8));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 288 */     return crypt(paramString1.getBytes(Charsets.UTF_8), paramString2);
/*     */   }
/*     */   
...
/* 293 */     int j = 0;
/* 294 */     int k = 0;
/* 295 */     for (byte b = 0; b < 25; b++) {
/* 296 */       for (byte b1 = 0; b1 < 32; b1 += 4) {
/* 297 */         i = dEncrypt(i, j, b1, paramInt1, paramInt2, paramArrayOfint);
/* 298 */         j = dEncrypt(j, i, b1 + 2, paramInt1, paramInt2, paramArrayOfint);
/*     */       } 
/* 300 */       k = i;
/* 301 */       i = j;
/* 302 */       j = k;
...
/* 306 */     j = i >>> 1 | i << 31;
/* 307 */     i = k >>> 1 | k << 31;
/* 308 */     int[] arrayOfInt1 = new int[2];
/* 309 */     permOp(j, i, 1, 1431655765, arrayOfInt1);
/* 310 */     j = arrayOfInt1[0];
/* 311 */     i = arrayOfInt1[1];
/* 312 */     permOp(i, j, 8, 16711935, arrayOfInt1);
/* 313 */     i = arrayOfInt1[0];
/* 314 */     j = arrayOfInt1[1];
/* 315 */     permOp(j, i, 2, 858993459, arrayOfInt1);
/* 316 */     j = arrayOfInt1[0];
/* 317 */     i = arrayOfInt1[1];
/* 318 */     permOp(i, j, 16, 65535, arrayOfInt1);
/* 319 */     i = arrayOfInt1[0];
/* 320 */     j = arrayOfInt1[1];
/* 321 */     permOp(j, i, 4, 252645135, arrayOfInt1);
/* 322 */     j = arrayOfInt1[0];
/* 323 */     i = arrayOfInt1[1];
/* 324 */     int[] arrayOfInt2 = new int[2];
/* 325 */     arrayOfInt2[0] = i;
/* 326 */     arrayOfInt2[1] = j;
/* 327 */     return arrayOfInt2;
/*     */   }
/*     */   
/*     */   private static int byteToUnsigned(byte paramByte) {
/* 331 */     byte b = paramByte;
/* 332 */     return (b < 0) ? (b + 256) : b;
/*     */   }
/*     */   
/*     */   private static int dEncrypt(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int[] paramArrayOfint) {
/* 336 */     int i = paramInt2 ^ paramInt2 >>> 16;
/* 337 */     int j = i & paramInt4;
/* 338 */     i &= paramInt5;
/* 339 */     j = j ^ j << 16 ^ paramInt2 ^ paramArrayOfint[paramInt3];
/* 340 */     int k = i ^ i << 16 ^ paramInt2 ^ paramArrayOfint[paramInt3 + 1];
/* 341 */     k = k >>> 4 | k << 28;
/* 342 */     paramInt1 ^= SPTRANS[1][k & 0x3F] | SPTRANS[3][k >>> 8 & 0x3F] | SPTRANS[5][k >>> 16 & 0x3F] | SPTRANS[7][k >>> 24 & 0x3F] | SPTRANS[0][j & 0x3F] | SPTRANS[2][j >>> 8 & 0x3F] | SPTRANS[4][j >>> 16 & 0x3F] | SPTRANS[6][j >>> 24 & 0x3F];
/*     */ 
/*     */     
/* 345 */     return paramInt1;
/*     */   }
/*     */   
/*     */   private static int[] desSetKey(byte[] paramArrayOfbyte) {
/* 349 */     int[] arrayOfInt1 = new int[32];
/* 350 */     int i = fourBytesToInt(paramArrayOfbyte, 0);
/* 351 */     int j = fourBytesToInt(paramArrayOfbyte, 4);
/* 352 */     int[] arrayOfInt2 = new int[2];
/* 353 */     permOp(j, i, 4, 252645135, arrayOfInt2);
/* 354 */     j = arrayOfInt2[0];
/* 355 */     i = arrayOfInt2[1];
/* 356 */     i = hPermOp(i, -2, -859045888);
/* 357 */     j = hPermOp(j, -2, -859045888);
/* 358 */     permOp(j, i, 1, 1431655765, arrayOfInt2);
/* 359 */     j = arrayOfInt2[0];
/* 360 */     i = arrayOfInt2[1];
/* 361 */     permOp(i, j, 8, 16711935, arrayOfInt2);
/* 362 */     i = arrayOfInt2[0];
/* 363 */     j = arrayOfInt2[1];
/* 364 */     permOp(j, i, 1, 1431655765, arrayOfInt2);
/* 365 */     j = arrayOfInt2[0];
/* 366 */     i = arrayOfInt2[1];
/* 367 */     j = (j & 0xFF) << 16 | j & 0xFF00 | (j & 0xFF0000) >>> 16 | (i & 0xF0000000) >>> 4;
/* 368 */     i &= 0xFFFFFFF;
/* 369 */     byte b1 = 0;
/* 370 */     for (byte b2 = 0; b2 < 16; b2++) {
/* 371 */       if (SHIFT2[b2]) {
/* 372 */         i = i >>> 2 | i << 26;
/* 373 */         j = j >>> 2 | j << 26;
/*     */       } else {
...
/* 378 */       i &= 0xFFFFFFF;
/* 379 */       j &= 0xFFFFFFF;
/* 380 */       int k = SKB[0][i & 0x3F] | SKB[1][i >>> 6 & 0x3 | i >>> 7 & 0x3C] | SKB[2][i >>> 13 & 0xF | i >>> 14 & 0x30] | SKB[3][i >>> 20 & 0x1 | i >>> 21 & 0x6 | i >>> 22 & 0x38];
/*     */ 
/*     */       
/* 383 */       int m = SKB[4][j & 0x3F] | SKB[5][j >>> 7 & 0x3 | j >>> 8 & 0x3C] | SKB[6][j >>> 15 & 0x3F] | SKB[7][j >>> 21 & 0xF | j >>> 22 & 0x30];
/*     */       
/* 385 */       arrayOfInt1[b1++] = m << 16 | k & 0xFFFF;
/* 386 */       k = k >>> 16 | m & 0xFFFF0000;
/* 387 */       k = k << 4 | k >>> 28;
/* 388 */       arrayOfInt1[b1++] = k;
/*     */     } 
/*     */     
/* 391 */     return arrayOfInt1;
/*     */   }
/*     */   
/*     */   private static int fourBytesToInt(byte[] paramArrayOfbyte, int paramInt) {
/* 395 */     int i = byteToUnsigned(paramArrayOfbyte[paramInt++]);
/* 396 */     i |= byteToUnsigned(paramArrayOfbyte[paramInt++]) << 8;
/* 397 */     i |= byteToUnsigned(paramArrayOfbyte[paramInt++]) << 16;
/* 398 */     i |= byteToUnsigned(paramArrayOfbyte[paramInt++]) << 24;
/* 399 */     return i;
/*     */   }
/*     */   
/*     */   private static int hPermOp(int paramInt1, int paramInt2, int paramInt3) {
/* 403 */     int i = (paramInt1 << 16 - paramInt2 ^ paramInt1) & paramInt3;
/* 404 */     paramInt1 = paramInt1 ^ i ^ i >>> 16 - paramInt2;
/* 405 */     return paramInt1;
/*     */   }
/*     */   
/*     */   private static void intToFourBytes(int paramInt1, byte[] paramArrayOfbyte, int paramInt2) {
/* 409 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 & 0xFF);
/* 410 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 >>> 8 & 0xFF);
/* 411 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 >>> 16 & 0xFF);
/* 412 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 >>> 24 & 0xFF);
/*     */   }
/*     */   
/*     */   private static void permOp(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint) {
/* 416 */     int i = (paramInt1 >>> paramInt3 ^ paramInt2) & paramInt4;
/* 417 */     paramInt1 ^= i << paramInt3;
/* 418 */     paramInt2 ^= i;
/* 419 */     paramArrayOfint[0] = paramInt1;
/* 420 */     paramArrayOfint[1] = paramInt2;
/*     */   }
/*     */ }


/* Location:              /home/octo/Downloads/Telegram Desktop/UltraPermissions-4.8.9-Cracked.jar!/me/TechsCode/UltraPermissions/dependencies/commons/codec/digest/UnixCrypt.class
