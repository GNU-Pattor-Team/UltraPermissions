...
/*  66 */     this.value = paramNumber.doubleValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  78 */     this.value = Double.parseDouble(paramString);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 108 */     setValue(((Number)paramObject).doubleValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 271 */     return (paramObject instanceof MutableDouble && Double.doubleToLongBits(((MutableDouble)paramObject).value) == Double.doubleToLongBits(this.value));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public int hashCode() {
/* 281 */     long l = Double.doubleToLongBits(this.value);
/* 282 */     return (int)(l ^ l >>> 32L);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 294 */     MutableDouble mutableDouble = (MutableDouble)paramObject;
/* 295 */     double d = mutableDouble.value;
/* 296 */     return NumberUtils.compare(this.value, d);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /home/octo/Downloads/Telegram Desktop/UltraPermissions-4.8.9-Cracked.jar!/me/TechsCode/UltraPermissions/dependencies/commons/lang/mutable/MutableDouble.class
